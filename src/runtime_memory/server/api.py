"""REST API Server for Runtime Memory.
...
class APIConfig:
    ...
    def __init__(
        ...
        self.api_key = api_key or os.environ.get("RUNTIME_MEMORY_API_KEY")
...
def create_app(
    ...
    # Create app
    app = FastAPI(
        title="Runtime Memory API",
        description="REST API for Runtime Memory - Persistent memory for AI coding agents",
        version=__version__,
        docs_url="/docs",
        redoc_url="/redoc",
    )
...
async def get_metrics():
    ...
    """
    from runtime_memory.core.observability import get_metrics_collector
